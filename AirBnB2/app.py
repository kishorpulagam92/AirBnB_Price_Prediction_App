...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/npulagam/AirBnB_Price_Prediction_App/master/AirBnB2/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: -54256.42946324167
exported_pipeline = DecisionTreeRegressor(max_depth=6, min_samples_leaf=18, min_samples_split=19)
...
encoder_location = 'https://github.com/npulagam/AirBnB_Price_Prediction_App/blob/master/AirBnB2/encoder.pkl?raw=true'
