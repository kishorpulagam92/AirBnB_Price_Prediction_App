...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/npulagam/AirBnB_Price_Prediction_App/master/AirBnB/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: -50154.74120783622
...
encoder_location = 'https://github.com/npulagam/AirBnB_Price_Prediction_App/blob/master/AirBnB/encoder.pkl?raw=true'
